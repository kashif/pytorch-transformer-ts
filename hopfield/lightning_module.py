...
class HopfieldLightningModule(pl.LightningModule):
    def __init__(
        self,
        model_kwargs: dict,
        # model: HopfieldModel,
        ...
        self.model = HopfieldModel(**self.hparams.model_kwargs)
    ...
    def forward(self, batch):
        ...
        hopfield_inputs, loc, scale, _ = self.model.create_network_inputs(
            past_target,
            past_observed_values,
            future_target,
        )
        params = self.model.output_params(hopfield_inputs)
