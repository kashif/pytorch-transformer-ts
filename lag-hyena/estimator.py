...
class LagHyenaEstimator(PyTorchLightningEstimator):
    """
    ...
    def create_lightning_module(self) -> pl.LightningModule:
        ...
        if self.ckpt_path is not None:
            return LagHyenaLightningModule.load_from_checkpoint(
            ...
            return LagHyenaLightningModule(
                loss=self.loss,
                lr=self.lr,
                weight_decay=self.weight_decay,
                aug_prob=self.aug_prob,
    ...
    def _create_instance_splitter(self, module: LagHyenaLightningModule, mode: str):
    ...
    def create_training_data_loader(
        self,
        data: Dataset,
        module: LagHyenaLightningModule,
