...
class HopfieldEstimator(PyTorchLightningEstimator):
    @validated()
    def __init__(
        self,
        # freq: str,
    ...
    def _create_instance_splitter(self, module: HopfieldLightningModule, mode: str):
    ...
    def create_training_data_loader(
        self,
        data: Dataset,
        module: HopfieldLightningModule,
    ...
    def create_lightning_module(self) -> HopfieldLightningModule:
        model_kwargs = {
            # freq=self.freq,
        ...
        if self.ckpt_path is not None:
            return HopfieldLightningModule.load_from_checkpoint(
                self.ckpt_path,
            ...
            return HopfieldLightningModule(
                model_kwargs=model_kwargs,
                loss=self.loss,
                lr=self.lr,
                weight_decay=self.weight_decay,
        ...
        # return HopfieldLightningModule(model=model, loss=self.loss)
