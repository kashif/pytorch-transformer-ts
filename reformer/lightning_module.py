...
class ReformerLightningModule(pl.LightningModule):
    def __init__(
        self,
        model: ReformerModel,
    ...
    def forward(self, batch):
        ...
        reformer_inputs, loc, scale, _ = self.model.create_network_inputs(
            feat_static_cat,
            feat_static_real,
            past_time_feat,
            past_target,
        ...
        params = self.model.output_params(reformer_inputs)
